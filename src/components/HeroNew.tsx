    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center py-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-400/30 via-blue-300/20 to-transparent rounded-full filter blur-3xl animate-blob" />
          <div className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-bl from-blue-500/25 via-blue-400/15 to-transparent rounded-full filter blur-3xl animate-blob animation-delay-2000" />
          <div className="absolute bottom-0 left-1/3 w-96 h-96 bg-gradient-to-tr from-blue-300/20 via-blue-200/10 to-transparent rounded-full filter blur-3xl animate-blob animation-delay-4000" />
        ...
        <div className="container relative z-10 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center space-y-8 mb-16">
            ...
            <div className="space-y-3 sm:space-y-4 max-w-4xl px-4 relative">
        ...
        <section id="faq" className="relative py-16 md:py-24 bg-white" style={{scrollMarginTop: '80px'}}>
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={index} className="group bg-white border-2 border-blue-100 rounded-xl p-6 hover:border-blue-900 transition-all">
                <summary className="flex items-center justify-between cursor-pointer list-none">
                  <span className="text-lg font-semibold text-gray-900 group-open:text-blue-900">{faq.q}</span>
      ...
      >
        <div className="relative">
          ...
          {/* Main button */}
          <div className="relative w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-full shadow-2xl flex items-center justify-center group-hover:scale-110 group-hover:from-green-600 group-hover:to-green-700 transition-all duration-300">
            <svg
