...
const DashboardLayout: React.FC = () => {
  ...
  const handleDownloadReport = useCallback(() => {
    ...
    const reportContent = `
===========================================
📊 LAPORAN ANALISIS FASHION SKIRO
===========================================
      ...
      `}>
        ...
        {sidebarOpen && state.fileName && (
          <div className="p-4 bg-blue-900/50 border-b border-blue-800">
            ...
            {state.rawFileData && (
              <p className="text-xs text-blue-300 mt-1">📊 {state.rawFileData.length} baris data</p>
            )}
          </div>
        )}
        ...
        <div className="p-4 md:p-6 max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              {!state.fashionAnalysis && !showUploadForm && (
                <>
                  ...
                  {/* Mobile-only auto carousel */}
                  <div className="lg:hidden">
                    {/* Simple carousel using Embla */}
                    <MobileFeatureCarousel />
                    <div className="flex justify-center mt-3">
                      <Button
                        onClick={() => setShowUploadForm(true)}
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-xl text-sm"
                      >
                        Mulai Sekarang
              ...
              <div className="relative text-center py-3">
                ...
                <div className="relative space-y-3">
                  ...
                  {/* Active File Badge */}
                  {state.fileName && (
                    <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg sm:rounded-xl shadow-md max-w-full overflow-hidden">
                      <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
                        <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" />
                        <span className="text-[10px] sm:text-xs font-medium text-green-900">File Aktif:</span>
                      </div>
                      <span className="text-[10px] sm:text-xs font-bold text-green-700 truncate flex-1 min-w-0">{state.fileName}</span>
                      <div className="flex items-center gap-1 px-1.5 sm:px-2 py-0.5 bg-white rounded-md sm:rounded-lg border border-green-200 flex-shrink-0">
                        <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-green-500 animate-pulse" />
                        <span className="text-[8px] sm:text-[10px] font-semibold text-green-700">Ready</span>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="relative group">
                ...
                <div className="hidden sm:block absolute inset-0 bg-gradient-to-r from-green-500/20 via-emerald-500/20 to-green-500/20 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center gap-3 sm:gap-4">
                      ...
                      <div className="flex-shrink-0">
                        <div className="relative">
                          <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl sm:rounded-2xl blur-lg opacity-50 animate-pulse" />
                          <div className="relative w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                      ...
                      <div className="flex-1 space-y-1.5 sm:space-y-2">
                        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                          ...
                          <span className="px-1.5 sm:px-2 py-0.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-[9px] sm:text-[10px] font-bold rounded-full shadow-sm flex-shrink-0">
                            FREE
                          </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-1 sm:gap-1.5">
                          <div className="inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-white/80 backdrop-blur-sm rounded-md sm:rounded-lg border border-green-200/50 shadow-sm">
                            <CheckCircle className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-green-600 flex-shrink-0" />
                            <span className="text-[9px] sm:text-[10px] font-semibold text-slate-700 whitespace-nowrap">Support Semua Size</span>
                          </div>
                          <div className="inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-white/80 backdrop-blur-sm rounded-md sm:rounded-lg border border-green-200/50 shadow-sm">
                            <CheckCircle className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-green-600 flex-shrink-0" />
                            <span className="text-[9px] sm:text-[10px] font-semibold text-slate-700 whitespace-nowrap">CSV & Excel</span>
                          </div>
                          <div className="inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-white/80 backdrop-blur-sm rounded-md sm:rounded-lg border border-green-200/50 shadow-sm">
                            <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-green-600 flex-shrink-0" />
                            <span className="text-[9px] sm:text-[10px] font-semibold text-slate-700 whitespace-nowrap">Format mudah</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex-shrink-0">
                        ...
                        >
                          <Button size="sm" className="group/btn relative bg-gradient-to-r from-green-600 via-emerald-600 to-green-600 hover:from-green-700 hover:via-emerald-700 hover:to-green-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-1.5 sm:px-2.5 py-0 sm:py-1 text-[7px] sm:text-[10px] font-bold overflow-hidden h-4 sm:h-7 leading-none">
                            <div className="absolute inset-0 bg-white/20 translate-y-full group-hover/btn:translate-y-0 transition-transform duration-300" />
                            <Download className="w-1.5 h-1.5 sm:w-3 sm:h-3 mr-1 group-hover/btn:animate-bounce" />
                    ...
                    >
                      ...
                      <div className="relative flex flex-col items-center justify-center py-8 px-4 pointer-events-none z-10">
                        ...
                        <div className="relative group/btn mb-6">
                          ...
                          <div className="relative px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white rounded-lg sm:rounded-xl shadow-2xl text-[10px] sm:text-xs font-bold group-hover/btn:scale-105 transition-all duration-500 flex items-center gap-1 sm:gap-1.5 border border-white/20">
                ...
                <Card className="border-2 border-blue-200">
                  <CardHeader className="bg-blue-50">
                    <div className="flex items-center justify-between gap-2">
                      <CardTitle className="text-blue-900 flex items-center gap-1.5 sm:gap-2 text-[8px] sm:text-xs leading-snug break-words whitespace-break-spaces break-all">
                        <FileText className="w-3 h-3 sm:w-4 sm:h-4" />
                        <span className="break-words whitespace-break-spaces break-all text-[8px] sm:text-xs">Preview: {state.fileName}</span>
                      </CardTitle>
                      <div className="text-[10px] sm:text-sm text-blue-700 leading-snug text-right">
                        📊 {state.rawFileData.length} baris data • Upload: {state.uploadDate}
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      <Alert className="bg-green-50 border-green-200">
                        <AlertDescription className="text-green-900 text-xs sm:text-sm leading-snug">
                          <strong>✅ File berhasil diupload!</strong> Sistem sudah analisis {state.rawFileData.length} baris data.
                          Scroll ke bawah untuk lihat preview data atau klik menu lain untuk melihat analisis lengkap.
                        </AlertDescription>
                      </Alert>
                        ...
                        <div className="overflow-x-auto max-h-96 overflow-y-auto">
                          <table className="min-w-full divide-y divide-gray-200 text-[11px] sm:text-xs">
                            <thead className="bg-gray-50 sticky top-0 z-10">
                              <tr>
                                <th className="px-2 py-2 text-left text-[10px] sm:text-[11px] font-medium text-gray-500 uppercase tracking-wider bg-gray-100">
                                  #
                                </th>
                                {state.fileHeaders.map((header, idx) => (
                                  <th 
                                    key={idx} 
                                    className="px-2 py-2 text-left text-[10px] sm:text-[11px] font-medium text-gray-500 uppercase tracking-wider bg-gray-100 break-words"
                                  >
                                    {header || `Column ${idx + 1}`}
                                  </th>
                                ))}
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              {state.rawFileData.slice(0, 50).map((row, rowIdx) => (
                                <tr key={rowIdx} className={rowIdx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                  <td className="px-2 py-2 text-[10px] sm:text-[11px] text-gray-900 font-medium">
                                    {rowIdx + 1}
                                  </td>
                                  {state.fileHeaders.map((header, colIdx) => (
                                    <td 
                                      key={colIdx} 
                                      className="px-2 py-2 text-[10px] sm:text-[11px] text-gray-700 break-words leading-snug"
                                    >
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                        ...
                        <Button 
                          onClick={handleNewUpload}
                          variant="outline"
                          className="border-red-300 text-red-600 hover:bg-red-50 text-xs sm:text-sm py-2"
                        >
          ...
          {activeView === 'reports' && state.fashionAnalysis && (
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>🎯 Insight Penting</CardTitle>
                </CardHeader>
                <CardContent>
...
// Mobile feature carousel component
const MobileFeatureCarousel: React.FC = () => {
  const slides = [
    {
      color: 'blue',
      icon: Package,
      title: '1. Upload Data',
      desc: 'Upload file CSV atau Excel data penjualan. Sistem akan analisis otomatis.',
    },
    {
      color: 'purple',
      icon: BarChart3,
      title: '2. Analisis Pintar',
      desc: 'AI mengidentifikasi produk laku, stok numpuk, dan strategi terbaik.',
    },
    {
      color: 'green',
      icon: MessageSquare,
      title: '3. Konsultasi AI',
      desc: 'Tanya apapun ke AI Consultant untuk rekomendasi yang actionable.',
    },
  ];

  // Auto-play using a simple interval
  ...
  return (
    <Carousel className="w-full">
      <CarouselContent style={{ transform: `translateX(-${index * 100}%)`, transition: 'transform 600ms ease' }}>
        {slides.map((s, i) => (
          <CarouselItem key={i}>
            <Card className={`border bg-gradient-to-br from-${s.color}-50 to-white`}>
              <CardHeader className="pb-2">
                <div className={`w-9 h-9 rounded-lg bg-gradient-to-br from-${s.color}-600 to-${s.color}-700 flex items-center justify-center mb-2`}>
                  <s.icon className="w-5 h-5 text-white" />
                </div>
                <CardTitle className="text-sm font-bold text-gray-900">{s.title}</CardTitle>
              </CardHeader>
